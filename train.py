...
# 训练神经网络并生成自我对弈数据
def generate_self_play_data(net, mcts, num_games=5):
    self_play_data = []
...
def train_neural_network(net, self_play_data, batch_size=32, learning_rate=0.01, epochs=200):
